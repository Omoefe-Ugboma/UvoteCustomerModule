...
export enum UserActionTypes {
  ...
  LoadUserMenu = '[UserMenu] Load UserMenu',
  LoadUserMenuSuccess = '[UserMenu] Load UserMenu Success',
  LoadUserMenuFail = '[UserMenu] Load UserMenu Fail',
...
export class LoadUserMenu implements Action {
  readonly type = UserActionTypes.LoadUserMenu;
}

export class LoadUserMenuSuccess implements Action {
  readonly type = UserActionTypes.LoadUserMenuSuccess;
...
export class LoadUserMenuFail implements Action {
  readonly type = UserActionTypes.LoadUserMenuFail;
  constructor(public payload: any) {}
}
...
export type UserActions = LoadUsers | LoadUserMenu |LoadUserMenuSuccess | LoadUserMenuFail| LoadUsersSuccess | LoadUsersFail | ResetUsers | LoadUserGroups | LoadUserGroupsSuccess | LoadUserGroupsFail |
