...
// menu user access
export const getUserMenuLoading = createSelector(getUserState, state => state.usermenu_loading);

// export const getUserMenuError = createSelector(getUserState, state => state.error);

export const getUserMenu = createSelector(getUserState, state => state.usermenu);

// export const getUserMenuByUUID = (UUID: string) => createSelector(getUserMenu, usermenu => {
//   if (usermenu) return usermenu.find((usermenu: { UUID: any; }) => usermenu.UUID == UUID);
//   return [];
// });
