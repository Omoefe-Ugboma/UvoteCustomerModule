...
export class CustomerUpdateComponent implements OnInit {
  ...
  get id2() {
    return this.createupdateCustomerAddressForm.get('id') as FormControl;
  }
...
// createAddress(form: FormGroupDirective) {
//     if (form.valid) {
//       const data = this.cuid ?
//         {...form.value, cuid: this.cuid, id: this.customer_id} : {...form.value, cuid: this.cuid};
//       this.addressService.createupdateCustomerAddress(data).subscribe(addr => {
//         console.log("wewew")
//         this.notifyService.showSuccess(addr.message);
//         this.getCustomerDetail();
//         form.resetForm();
//       }, error => {
//         this.notifyService.showError(getErrorObj(error).msg);
